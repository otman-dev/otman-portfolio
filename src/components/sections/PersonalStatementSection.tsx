  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto w-full flex flex-col items-center">
        ...
        <blockquote className="relative p-6 md:p-10 backdrop-blur-sm border border-blue-100 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 max-w-3xl mx-auto w-full">
